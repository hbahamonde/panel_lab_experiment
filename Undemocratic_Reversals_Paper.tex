...
The design's inferential leverage comes from changing the institutions' relative ``productivity'' (i.e., the ``benefit'' of living in such society). All participants first encounter an institutional crisis, specifically, in public-service provision, by being exposed to the following vignette: \texttt{Parliament has failed to pass a budget for eight months, healthcare waiting times have doubled, and planning for public services has stalled.} During this crisis, leader control (\Aproc{}) is more productive and prevents unilateral free-riding by requiring the same allocation from everyone. The key treatment then distinguishes {\bf institutional recovery}, which raises citizen control's productivity to \emph{match} \Aproc{}, from {\bf institutional persistence}, which retains the original gap. Importantly, institutional recovery does not make \Dproc{} more productive than \Aproc{}, or mechanically turn it into the higher-paying method (both societies remain equally ``beneficial'' under institutional recovery).\footnote{The leader's authority, compulsory allocation, transfer option, and productivity remain unchanged in both conditions.} Random assignment, therefore, identifies whether removing \Aproc{}'s crisis-based productivity advantage causes previous supporters to return to \Dproc{}. Such a return records a {\bf behavioral  reversal}: the same citizen might or might not withdraw the earlier authorization of one-person control, restoring (or not) individual decision rights.
