...
\footnotesize\textit{Notes:} The roster is fixed before Block 1. Ten-person pools are formed first; when the largest usable multiple of five ends in 15, one fifteen-person pool is formed. Participants never enter or change pools after paid play begins.
\end{minipage}
\end{table}
