...
The democratic backsliding literature has already established that illiberalism  not only depends on leaders who weaken constraints but also on citizens who authorize them. For example, we know that an institutional crisis (e.g., crime, immigration, inequality) can make that authorization attractive by giving concentrated power a practical advantage. While our question builds on the same insights, our contribution moves one step forward: what happens when that advantage \emph{disappears}? That is, \emph{once the crisis is over, do the same citizens that supported illiberalism reclaim their citizen rights back?} That within-person return to citizen control is the {\bf (\emph{un})democratic reversal} this project seeks to explain.

To causally identify the problem, an incentivized public-goods experimental game was developed. In a single session with repeated rounds\todo{not a panel exp in two sess anymore}, participants vote between two rules that govern the same shared fund. If a simply majority chooses the citizen-led rule (\Dproc), each person controls their own points, and no participant can remove points from the fund. If a simply majority choses centralized leader-led rule (\Aproc), one person (assigned at random) sets the same allocation for everyone. Importantly, they may move some fund points to their own payoff. A vote for \Aproc{} therefore authorizes ``weakly constrained'' centralized control: one participant replaces five individual allocation decisions with a binding group decision and gains discretion over part of the shared fund.

The design's inferential leverage comes from changing the institutions' relative ``productivity premium'' (i.e., the ``benefit'' of living in such society; refer to \autoref{eq:productivity-premium} for details). All participants first encounter an institutional crisis, specifically, in public-service provision, by being exposed to the following vignette: \texttt{Parliament has failed to pass a budget for eight months, healthcare waiting times have doubled, and planning for public services has stalled.} During this crisis, leader control (\Aproc{}) is more productive and prevents unilateral free-riding by requiring the same allocation from everyone. The key treatment is a switch from {\bf institutional recovery}, which raises citizen control's productivity to \emph{match} \Aproc{}, to {\bf institutional persistence}, which retains the original productivity gap. Importantly, institutional recovery does not make \Dproc{} more productive than \Aproc{}, or mechanically turn it into the higher-paying method (both societies remain equally ``beneficial'' under institutional recovery).\footnote{The leader's authority, compulsory allocation, transfer option, and productivity remain unchanged in both conditions.} Random assignment, therefore, identifies whether removing \Aproc{}'s crisis-based productivity premium causes previous supporters to return to \Dproc{}. Such a return records a {\bf behavioral reversal}: continued support for \Aproc{}, revealing \emph{a willingness to retain concentrated authority even after its crisis-based advantage has disappeared}. {\bf We argue that this consequential choice reveals \emph{more} than directly asking whether participants now ``prefer democracy.''}
...
These findings establish why authority can be attractive and why institutional choice can shape public-good provision. Unfortunately, they do not follow the reverse movement, which is the focus of this experimental design: {\bf whether citizens withdraw an earlier authorization after the structural condition that supported it changes}. Research on the demand side of democratic backsliding similarly explains why citizens tolerate norm violations or weakly constrained leaders, but says much less about when the same citizens reverse that support \parencite{7f36f,0b3bf,33fbf}. Bringing these literatures together turns (un)democratic reversal into an observable response in the context of an experimental design.

\emph{(Un)democratic reversal}, then, is the within-person change that connects these two moments. A participant who first chooses a rule that concentrates authority and weakens citizen control, but who then returns to a rule that preserves individual decision rights. {\bf This captures a demand-side step through which citizens may first enable and later resist executive aggrandizement}.

The experiment identifies that reversal through a simple comparison. Everyone begins under the same public-service crisis. After Block 1, matching pools are randomly assigned to institutional recovery or institutional persistence. Recovery removes the productivity premium of the leader-led fund; persistence preserves it. The leader's authority, compulsory coordination, and transfer option remain unchanged. The design then effectively varies only the productivity rate citizen-rule under reversal.

Repeated ballots and decisions show how that response develops. The first Block-2 ballot records the immediate effect of the new structural condition. The final ballot records whether reversal remains after ten rounds, while the persistence group shows the trajectory produced by repeated play alone. Further rounds provide evidence on whether participants recognized the change in relative productivity.

\begin{plainlanguagebox}
In each round, five citizens vote on how to manage a shared fund. Under ``Each person chooses'' (\Dproc), each controls their own allocation. Under ``One person chooses for the group'' (\Aproc), the software appoints a citizen (from those who have served least often). That leader sets the same allocation for everyone and may move fund points to their own payoff. The latter is public information: citizens see the result after every round.

In Block 1, each fund point produces 1.50 points under \Dproc{} and 2.50 under \Aproc{}, divided equally among five citizens. 

For example, if 10 fund points are allocated into the society, they will produce $10\times1.5=15$ under \Dproc{}, or $10\times2.5=25$ under \Aproc{}, giving each citizen $\frac{15}{5}=3$ or $\frac{25}{5}=5$ points each. Afterward, each ten-person pool is randomly assigned to institutional recovery, which raises \Dproc{} from 1.5 to 2.50, or institutional persistence, which keeps it at 1.50. The \Aproc{} rate and powers remain unchanged.

Citizens vote again in Block 2. Among previous \Aproc{} supporters, returning to \Dproc{} after institutional recovery (i.e., $\Dproc_{2.5}$) means reclaiming individual decision rights once one-person control \emph{no} longer has its $\Aproc_{2.5}-\Dproc_{1.5}=1$ ``productivity'' premium ($\Dproc_{2.5}=\Aproc_{2.5}$); continuing with \Aproc{} means retaining that authority after its crisis advantage disappears. The causal contrast compares how often these citizens return to \Dproc{} under institutional recovery ($\Dproc_{2.5}$) with how often they do so under institutional persistence ($\Dproc_{1.5}$). Because the same citizen cannot face both conditions, institutional persistence provides the counterfactual: {\bf how often comparable citizens would have returned to \Dproc{} had the productivity premium remained}. {\bf Random assignment therefore identifies how much removing that premium changes (un)democratic reversal}.
...
Participants remain in the same ten-person matching pool throughout the experiment, but are reshuffled into two temporary five-person groups before each round. The pool is denoted by \(g\), and the entire pool receives the same Block-2 condition (see \autoref{fig:pool-rematching}). Let \(T_g=1\) denote pools assigned to institutional recovery and \(T_g=0\) pools assigned to institutional persistence. Institutional recovery removes the leader's productivity premium. Let
...
denote the productivity premium of the leader-led fund over the citizen-led fund in matching pool \(g\) and block \(b\). Everyone faces \(\delta_{g1}=1.00\) in Block 1. In Block 2, institutional recovery sets \(\delta_{g2}=0\), whereas persistence keeps \(\delta_{g2}=1.00\). The leader's compulsory allocation, transfer option, selection rule, and 2.50 fund rate do not change.

Among participants who chose \Aproc{} at the end of Block 1, the analysis compares how many return to \Dproc{} in institutional recovery pools (\(T_g=1,\delta_{g2}=0\)) with how many return in institutional persistence pools (\(T_g=0,\delta_{g2}=1\)). {\bf This difference is the causal effect of removing the leader's productivity premium on (un)democratic reversal}. Persistence provides the counterfactual: \emph{how often citizens would have returned to \Dproc{} if the premium had remained}.
