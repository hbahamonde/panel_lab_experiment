...
\title{\includegraphics[width=0.32\textwidth]{utu_logo.pdf}\\[1.2em]
...
\date{\textbf{Principal Investigator and project contact:} Janne Tukiainen, Professor, Turku School of Economics, University of Turku; \href{mailto:janne.tukiainen@utu.fi}{janne.tukiainen@utu.fi}\\[0.4em]Version 2.3 --- 24 September 2026}
...
Each laboratory cohort completes one session lasting approximately 60 minutes, with two ten-round blocks. Subject to ethical review in September 2026, data collection is planned for 1--31 October 2026 at the UTU Choice Lab decision-making laboratory\irbdel{ and may also be conducted at Tampere University's Decision-making Laboratory (DMLab) to accelerate recruitment}. UTU Choice Lab has 24 regular seats plus one accessible seat\irbdel{, while DMLab has 20}; production rosters are capped at 20. \irbadd{Any later extension of data collection to another site will be submitted for ethical review as an amendment before collection begins there.} Participants remain in matching pools of 10 or 15 and are reshuffled into anonymous five-person groups before every paid round. After Block 1, each entire pool is assigned to recovery or persistence, learns whether public-service conditions improved or remained strained, and sees its Block-2 fund rates. Participants therefore interact repeatedly without forming stable five-person teams. In the figures, \(p_i\) identifies participant \(i\).
...
\fbox{\includegraphics[width=0.97\linewidth]{interface_institution_choice.jpg}}}
...
{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.4pt}%
\fbox{\includegraphics[width=0.97\linewidth]{interface_leader_allocation.jpg}}}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\textwidth}
\centering
\textbf{(b) Citizen approval}\par\smallskip
{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.4pt}%
\fbox{\includegraphics[width=0.97\linewidth]{interface_individual_allocation.jpg}}}
\end{minipage}

\vspace{0.8em}
\textbf{(c) Proposal, approval, and payoff feedback}\par\smallskip
{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.4pt}%
\fbox{\includegraphics[width=0.91\linewidth]{interface_round_result.jpg}}}
...
Strategic decisions do not time out automatically. The software records response time and flags decisions exceeding 90 seconds, but never generates a ballot or allocation. The \irbreplace{laboratory manager}{researcher or trained research assistant} monitors the session and prompts delayed participants to complete the current decision so the group can advance.

\FloatBarrier

\section{Implementation Plan}

The study will be conducted after ethical approval at the UTU Choice Lab decision-making laboratory\irbdel{ and may also be run at Tampere University's Decision-making Laboratory (DMLab) to accelerate recruitment}. Adults register through \irbreplace{the host laboratory's participant system}{UTU RPP/TOKA} and receive its general rules and privacy information. \irbreplace{UTU Choice Lab uses UTU RPP/TOKA; DMLab uses ORSEE. At either site,}{At UTU Choice Lab,} oTree provides project-specific information and records a short affirmative study consent before practice. The \irbreplace{laboratory manager}{researcher or trained research assistant} then fixes a consenting roster of 10, 15, or 20, forms the matching pools shown in Table~\ref{tab:attendance-pools-irb}, and handles any surplus arrivals under the \irbreplace{host laboratory's}{study's} procedure. No participant enters or changes pools after paid play begins.
...
Production sessions will last approximately 60 minutes. The \irbreplace{laboratory manager}{researcher or trained research assistant} will monitor synchronized progress and prompt delayed participants; the software will record delays but will never generate a ballot, proposal, approval decision, or allocation. A structured session log will record late arrivals, early departures, technical interruptions, staff interventions, and payment exceptions. The research team will review the log before applying preregistered data-quality rules.

\section{Recruitment, Participant Care, and Resources}

\irbreplace{The host laboratory}{UTU Choice Lab} will invite adults through its participant system using a neutral description of a paid study of group decision making and public-service provision. Recruitment will not disclose the directional hypotheses. Participation is voluntary and will not affect employment, studies, or access to University services. The fixed participation payment is EUR~10; points earned in one randomly selected round from each block determine a performance bonus of up to EUR~5.

Foreseeable risks are minimal. Participants may experience mild discomfort with unequal allocations, the fictional crisis, or waiting for an interacting group. Instructions avoid moral or partisan labels, individual ballots remain private, and only group-level outcomes are shown to other participants. \irbadd{Before the task, participants are told that the detailed research question will be explained after paid decisions. This limited incomplete disclosure is necessary because identifying the hypothesis about weakening and restoring approval could influence the institutional ballot itself; it does not withhold task rules, payments, data processing, foreseeable risks, or the right to stop.} The debrief explains the research interpretation immediately after paid decisions and emphasizes that no individual choice is treated as evidence of corruption, authoritarianism, or opposition to democracy.

Participant compensation is EUR~10--15, with a ceiling of EUR~4,500 for 300 completed participants. Laboratory charges and arrangements for timely arrivals who cannot enter a valid roster follow the agreement with \irbreplace{the host laboratory}{UTU Choice Lab}. Secure data services and routine dissemination costs follow available project funds. The experiment uses the open-source oTree platform and requires no proprietary experimental-software licence.

\section{Data Governance, Schedule, and Outputs}

The experimental interface uses participant codes rather than names. The production oTree study and coded research data are hosted on University of Turku IT servers in Finland\irbdel{, including for sessions conducted at DMLab}. \irbreplace{Each host laboratory separately administers the identifying information needed for recruitment, attendance, and payment under its own privacy notice. The research team receives only coded experimental data and never receives any temporary identity-to-code link; the host laboratory removes that link after payment under its procedure.}{UTU RPP/TOKA separately administers recruitment and attendance under its own privacy notice. It does not assign oTree codes, receive experimental responses, or administer payment. The research team makes immediate payment with a separate code-and-amount list; any named payment record contains no oTree code. The list is destroyed after payment reconciliation and no later than 30 November 2026, after which the retained research dataset is anonymised.} Access to coded research data is limited to Janne Tukiainen, Hector Bahamonde, and authorised personnel. Reporting will use aggregate or de-identified data, while \irbreplace{coded}{anonymised} data may be retained for verification and compatible future research under the research privacy notice.
...
1--31 October 2026 & Recruitment and laboratory data collection at UTU Choice Lab. \\
November--December 2026 & \irbadd{Payment reconciliation and anonymisation by 30 November, followed by} data verification, de-identification, reproducible cleaning, primary and secondary analyses, and robustness checks. \\
